package com.aquadev.aiexecutor.producer;

import com.aquadev.aiexecutor.config.kafka.KafkaTopicProperties;
...
public class HomeworkResultProducer {
    ...
    public void sendFailed(UUID executionId, String errorMessage) {
